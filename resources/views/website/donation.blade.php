            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <h6 class="heading-main">
                        ...
                        Thank you for supporting girls everywhere by making a gift to
                        Because She Can!
                    </h6>
                        ...
                        ">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <a href="#"><img src="images/body-images/donations/GoFundMe-Logo.png" alt="Go Fund ME" /></a>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <p class="text-primary">
                                    <a href="#"> This is simple a note to the donators regarding our
                                        services and policy.</a>
                                </p>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class=" theme-combo donation-select js-example-basic-single form-control" name="state"
                                            style="height: 400px">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <select class="theme-combo donation-select" id="state" name="Causes" style="height: 400px">
                                        <option>Select Causes</option>
                                        <option value="DECEMBER FOR WOMEN WHO CODE">DECEMBER FOR WOMEN WHO CODE</option>
                                        <option value="MIDYEAR BOOTCAMP">MIDYEAR BOOTCAMP</option>
                                        <option value="WEBINARS AND DISCUSSIONS">WEBINARS AND DISCUSSIONS</option>
