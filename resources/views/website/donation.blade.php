                        ...
                        ">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <a href="#"><img src="images/body-images/donations/GoFundMe-Logo.png"
                                                alt="Go Fund ME" /></a>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <select class="theme-combo donation-select" id="state" name="Causes"
                                            style="height: 400px">
                                            <option>Select Causes</option>
                                            <option value="DECEMBER FOR WOMEN WHO CODE">DECEMBER FOR WOMEN WHO CODE
                                            </option>
