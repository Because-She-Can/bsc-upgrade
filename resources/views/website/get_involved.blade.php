            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-12">
                    <div>
                        ...
                        <p>That’s 14% of the world’s population. Put another way, that's 1 in 8 people alive today
                            living without hope amongst trash, sewage, drugs, and abuse in unimaginable conditions. Life
                            without secure housing is a life without basic needs being met.</p>
                        <p>
                            As a member, you’ll have access to in-person and virtual events and workshops designed to
                            help you grow professionally and personally. Plus, find a mentor, build meaningful
                            relationships, and take advantage of our Jobs Board to find a job that’s right for you. Best
                            part? Membership is free.
                ...
                <div class="inner-title col-lg-offset-6 col-lg-6 bg-overlay-black-90 text">
                    ...
                    <div class="icon-label">
                        <span class="tag">
                            <figure class="icon-fluid">
                                <img class="img-fluid" src="images/body-images/EducationIcon.png"
                    ...
                    <figure class="icon-fluid">
                     ...
                     <strong>Experiences</strong>
                        ...
                        <span class="tag">
                            <figure class="icon-fluid">
                                <img class="img-fluid" src="images/body-images/CommunityIcon.png"
                                    alt="about-content-image">
                                    ...
                                    <div class="container three-columns columns-wrap">
                                        <div class="row" style="text-align: center;">
                                            ...
                                            <div class="col-12 col-md-4 text-center">
                                                <figure>
                                                    <img width="260" height="260" src="images/team/afi.jpeg" class=""
                                                        alt="" loading="lazy">
                                                </figure>
                                                <div class="text">
