!(function (e) {
    ...
    var o = {
        ...
        select_donation: function () {
            e(".donation-select").length &&
                e(".donation-select").select2({
                    width: "resolve",
                    theme: "form-dark",
        ...
        select_light: function () {
            e(".form-light-select").length &&
                e(".form-light-select").select2({
                    width: "resolve",
                    theme: "form-light",
                    minimumResultsForSearch: -1,
                });
        ...
        select_charity_home: function () {
            e(".home-charity").length &&
                e(".home-charity").select2({
                    width: "resolve",
                    theme: "form-light",
        ...
        mobile_dropdown: function () {
            e(".home-charity").length &&
                e(".dropdown-menu a.dropdown-toggle-mob").on(
                    "click",
                    function (o) {
                        return (
        ...
        header_anim: function () {
            e(".header-fullpage").length &&
                e(window).scroll(function () {
                    e(this).scrollTop() > 50
                        ? e(".header-fullpage").addClass("fixed")
                        : e(".header-fullpage").removeClass("fixed");
                });
        },
        search_overlay: function () {
            e(".overlay-close").length &&
                e("#search_home, .overlay-close").on("click", function (o) {
                    o.preventDefault(), e(".overlay").toggleClass("open");
                });
        },
        back_to_top: function () {
            e("#mkdf-back-to-top").length &&
                (e(window).scroll(function () {
                    e(this).scrollTop() > 100
                        ? e("#mkdf-back-to-top").addClass("on")
                        : e("#mkdf-back-to-top").removeClass("on");
                }),
        ...
        toggle_accordion: function () {
            e(".toggle").length &&
                e(".toggle").click(function () {
                    e(".toggle").removeClass("arrow-down"),
                        e(this).next().hasClass("show") ||
                            (e(this)
                                .parent()
                                .children(".collapse.show")
                                .collapse("hide"),
                            e(this).toggleClass("arrow-down")),
                        e(this).next().collapse("toggle");
                });
        },
        animated_skillbar: function () {
            e(".skillbar").length &&
                (e(".skillbar").appear(),
                e(".skillbar").on("appear", function () {
                    e(this)
                        .find(".skillbar-bar")
        ...
        carousel_home_testimonials: function () {
            e("#home-client-testimonials").length &&
                e("#home-client-testimonials").owlCarousel({
                    items: 2,
                    margin: 30,
                    loop: !0,
                    nav: !0,
                    ...
                    autoheight: !0,
                    navText: [
                        '<span class="icofont-arrow-left"></span>',
        ...
        carousel_our_donator: function () {
            e("#our-donator-slider-warp").length &&
                e("#our-donator-slider-warp").owlCarousel({
                    items: 2,
                    margin: 30,
                    loop: !0,
                    nav: !1,
        ...
        carousel_home_clients: function () {
            e("#home-clients").length &&
                e("#home-clients").owlCarousel({
                    items: 2,
                    margin: 30,
                    loop: !0,
                    nav: !1,
        ...
        carousel_home_blog: function () {
            e("#home-blog-post").length &&
                e("#home-blog-post").owlCarousel({
                    items: 1,
                    margin: 30,
                    loop: !0,
                    nav: !0,
        ...
        carousel_home_second_blog: function () {
            e("#home-second-blog-post").length &&
                e("#home-second-blog-post").owlCarousel({
                    items: 1,
                    margin: 30,
                    loop: !0,
                    nav: !0,
        ...
        carousel_aside_causes: function () {
            e("#sidebar-causes").length &&
                e("#sidebar-causes").owlCarousel({
                    items: 1,
                    margin: 30,
                    loop: !0,
                    nav: !1,
        ...
        carousel_home_second_causes: function () {
            e("#home-second-causes").length &&
                e("#home-second-causes").owlCarousel({
                    items: 1,
                    margin: 30,
                    loop: !0,
                    nav: !1,
        ...
        carousel_home_second_events: function () {
            e("#home-second-events").length &&
                e("#home-second-events").owlCarousel({
                    items: 1,
                    margin: 30,
                    loop: !0,
                    nav: !0,
        ...
        carousel_home_second_testimonials: function () {
            e("#home-second-testimonials").length &&
                e("#home-second-testimonials").owlCarousel({
                    items: 1,
                    margin: 30,
                    loop: !0,
                    nav: !0,
        ...
        contact_form: function () {
            e("#contact_form").length &&
                e("#contact_form").validate({
                    meta: "validate",
