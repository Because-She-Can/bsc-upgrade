...
var App = {
    ...
    body_height: function() {
        ...
        if ($("body").hasClass("fixed_menu")) {
            $(document).scroll(function() {
                ...
                if (y > 35) {
                    $("#main_menu_bar .navbar-header").fadeIn(
                        500,
                        function() {}
                    );
                } else {
        ...
        if (_container.length > 0) {
            var pageContainerClass = "page-container",
                ...
                bottomNavbar =
                $("." + bottomNavbarClass).length &&
                $("." + bottomNavbarClass).outerHeight(),
                availableHeight =
                $(window).height() -
                $("." + pageContainerClass).offset().top -
                bottomNavbar;
            $("." + pageContainerClass).attr(
                "style",
    ...
    panel_elements: function() {
        "use strict";
        $(".panel .heading-elements .refresh_element").on(
            "click",
            function(e) {
                e.preventDefault();
                ...
                if (!$(a).hasClass("panel-loading")) {
                    ...
                    $(a).addClass("panel-loading"),
                        $(t).prepend(
                            '<div class="panel-loader"><span class="loading_small"></span></div>'
                        ),
                        setTimeout(function() {
        ...
        $(".panel .heading-elements .fullscreen_element").on(
            "click",
            function(e) {
                e.preventDefault();
                var a = $(this).closest(".panel");
        ...
        $(".panel .heading-elements .collapse_element").on(
            "click",
            function(e) {
                e.preventDefault();
        ...
        $(window).scroll(function() {
            $(this).scrollTop() > offset ?
                ...
                $back_to_top.removeClass(
                    "back-to-top-is-visible cd-fade-out"
                );
    ...
    equal_height: function() {
        App.includeScript(
            plugin_path + "jquery-equal-height/jquery-equal-height.min.js",
            function() {
                $(".equal_height").jQueryEqualHeight(".make_equal");
                $(window)
                    .on("resize", function() {
    ...
    lazy_load: function() {
        App.includeScript(
            plugin_path + "jquery.lazy/jquery.lazy.min.js",
            function() {
                $(".lazy").lazy();
            }
        );
    ...
    place_holder: function(id, sentences, startOnFocus) {
        var startOnFocus =
            typeof startOnFocus == "undefined" ? true : startOnFocus;
        var sentences =
    ...
    fancy_box: function() {
        ...
        if (_container.length > 0) {
            ...
            App.includeStyle(
                plugin_path + "fancybox/css/jquery.fancybox.min.css"
            );
            App.includeScript(
                plugin_path + "fancybox/js/jquery.fancybox.min.js",
                function() {}
            );
        }
    },
    google_map: function() {
        ...
        if (_container.length > 0) {
            var a = [{
                ...
                {
                    featureType: "water",
                    stylers: [{ visibility: "on" }, { color: "#0072ff" }],
                },
            ];

            var t = {
                zoom: 13,
                center: new google.maps.LatLng(12.97, 77.6),
    ...
    showCookie: function() {
        if (!$.cookie("ppbox")) {
            ...
            if (
                confirm(
                    "Cookie already Accepted. Do you want to show it again.?"
                )
            ) {
    ...
    cookie_close: function() {
        ...
        if (_container.length > 0) {
            ...
            $(".col-lg-4 .feature")
                ...
                .on("click", function() {
                    var id = $(this).attr("id");
                    $("#cookie_modal").removeClass(
                        "left_top left_bottom right_top right_bottom top_center bottom_center"
                    );
        ...
        if (_container.length > 0) {
            ...
            $(".sidebar .nav > .has-sub-menu > a").on("click", function() {
                ...
                $(e).hasClass("in") ?
                    $(e).collapse("hide") :
                    $(e).collapse("show");
                $(".sidebar .nav > li.has-sub-menu > .sub-menu")
                    .not(e)
                    .collapse("hide");
            ...
            if (mobile_menu_initialized) {
                ...
                $(".sidebar-wrapper .dropdown .dropdown-menu > li > a").on(
                    "click",
                    function(event) {
            ...
            $("body").on("click", "#header, #page-container", function() {
                if ($(".template-options-wrapper").hasClass("show")) {
                    ...
                    $("#theme_panel_icon")
                        .removeClass("ion-ios-close-outline")
                        .addClass("ion-ios-settings");
                }
            });
            ...
            $("#fixed_topbar").on("change", function() {
                ...
                $(".navbar.navbar-default")
                    .first()
                    .toggleClass("navbar-fixed-top bordered");
    ...
    icons: function() {
        ...
        $.each(links, function(key, value) {
            $(value).addClass(
                "icons icon-" + classes[Math.floor(Math.random() * length)]
            );
        });
    },
    breadcrumb: function() {
    ...
    inputSelect: function() {
        ...
        $.each(
            $(
                '#page-container input[type="text"], #page-container input[type="password"]'
            ),
            function(i, d) {
        ...
        $.each(
            $(
                '#page-container input[type="radio"], #page-container input[type="checkbox"]'
            ),
            function(i, d) {
                var label = $(d).closest(".form-group").find(".control-label");
            ...
            $(".select_2_search_starts").select2({
                ...
                matcher: function(params, data) {
                    ...
                    if (
                        data.text
                        .toLowerCase()
                        .startsWith(params.term.toLowerCase())
                    ) {
